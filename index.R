...
### Solution of task on the argument `fixed_vals` ### 

# `fixed_vals` allows us to change where to slice the parameters that are not shown in the plots. 
# The plot below makes the unshown parameters equal to the values in `chosen_params`
emulator_plot(ems_wave1$R200, params = c('beta1', 'gamma'),
